...
class Edgenet_Cat {
	...
	public function __construct() {
		...
		add_action( 'created_term', [ $this, 'save_category_fields' ] );
		add_action( 'edit_term', [ $this, 'save_category_fields' ] );
	...
	public function manage_terms_columns( $columns ) {
		...
		$i       = array_search( "slug", array_keys( $columns ) );
		$columns = array_slice( $columns, 0, $i, true ) + [ 'meta' => 'Linked' ] + array_slice( $columns, $i, null, true );

		return $columns;
	}

	function custom_column( $content, $column_name, $term_id ) {
